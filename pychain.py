...
class Record:
    ...
    receiver: str
    # Define an attribute named 'amount' with a type of 'str'.
    amount: float 
...
def setup():
    ...
    return PyChain([Record("Genesis", 0)])
...
input_sender = st.text_input("sender_info")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
input_receiver = st.text_input("receiver_info")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
input_amount = st.text_input("amount_info")
